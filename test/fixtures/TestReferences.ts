...
import { RootBundleFactory } from '../../src/build/RootBundleFactory';
import { RootBundleServiceFactory } from '../../src/build/RootBundleServiceFactory';

export class TestReferences extends ManagedReferences {
    private _factory = new RootBundleFactory();
